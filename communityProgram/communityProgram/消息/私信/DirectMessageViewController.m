...
//
static NSString *directIdentifire = @"directIdentifire";
...
{
    DirectMessageTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:directIdentifire];
    if (!cell) {
        cell = [[DirectMessageTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:directIdentifire];
    }
