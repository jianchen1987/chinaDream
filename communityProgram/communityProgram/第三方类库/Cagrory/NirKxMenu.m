...
- (void)singleTap:(UITapGestureRecognizer *)recognizer
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"KxMenuOverlayClick" object:self userInfo:nil];
            ...
            withOptions:(OptionalConfiguration) options
{
    ...
    KxMenuOverlay *overlay = [[KxMenuOverlay alloc] initWithFrame:CGRectMake(0, 0, DeviceWidth, DeviceHeight) maskSetting:self.kxMenuViewOptions.maskToBackground];
...
{
    [[NSUserDefaults standardUserDefaults] setBool:NO forKey:@"show"];
