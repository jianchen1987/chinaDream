    ...
    if (self = [super init]) {
        ...
        if (titles.count) {
            ...
            for (int i = 0; i < titles.count; i++) {
                ...
                UIImage *bgImage = [UIImage imageWithContentsOfFile:@"bgImage_HL"];
            ...
            for (int i = 0; i < titles.count; i++) {
                ...
                UIView *separaView = [[UIView alloc] initWithFrame:CGRectMake(0, lineY, DeviceWidth, 1.0f)];
                separaView.backgroundColor = RGBA(240, 240, 240, 1);
                [bottomView addSubview:separaView];
