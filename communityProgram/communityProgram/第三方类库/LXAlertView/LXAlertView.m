...
#define LXADMessageFont     [UIFont systemFontOfSize:17];
#define LXADBtnTitleFont    [UIFont systemFontOfSize:16];
...
-(instancetype)initWithTitle:(NSString *)title message:(NSString *)message cancelBtnTitle:(NSString *)cancelTitle otherBtnTitle:(NSString *)otherBtnTitle clickIndexBlock:(LXAlertClickIndexBlock)block{
    if(self=[super init]){
        ...
        if (cancelTitle) {
            ...
            [_cancelBtn setBackgroundImage:[UIImage imageNamed:@"shoppingcarDelCancelBtn"] forState:UIControlStateNormal];
        ...
        if (otherBtnTitle) {
            ...
            [_otherBtn setBackgroundImage:[UIImage imageNamed:@"shoppingcarDelConfimBtn"] forState:UIControlStateNormal];
        ...
        CGFloat btn_y = _alertView.frame.size.height - LXABtn_H -10;
