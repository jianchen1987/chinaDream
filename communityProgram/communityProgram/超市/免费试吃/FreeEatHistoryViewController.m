//
//  FreeEatHistoryViewController.m
//  communityProgram
//
//  Created by xiaogao on 16/1/31.
//  Copyright © 2016年 高国峰. All rights reserved.
//
static NSString *freeEatHistoryIdentifire = @"freeEatHistoryIdentifire";
#import "FreeEatHistoryViewController.h"

@interface FreeEatHistoryViewController ()

@end

@implementation FreeEatHistoryViewController
...
- (void)viewDidLoad {
    ...
    [myCollectionView registerClass:[FreeEatHistoryCollectionViewCell class] forCellWithReuseIdentifier:freeEatHistoryIdentifire];
...
{
    cell = [collectionView dequeueReusableCellWithReuseIdentifier:freeEatHistoryIdentifire forIndexPath:indexPath];
...
{
    UICollectionViewCell *cell = (FreeEatHistoryCollectionViewCell *)[collectionView cellForItemAtIndexPath:indexPath];
